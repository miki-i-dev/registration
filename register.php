            ...
            <form action="register_confirm.php" method="post" enctype="multipart/form-data">
                <div class="form_contents">
                    ...
                    <div class="password">
                        ...
                        <input type ="password" class="formbox" size="40" name="check_password" id="check" oninput="checkPassword()" required>
                    </div>
                    ...
                    <div class="comment">
                        <label>コメント(250文字まで)</label><br>
                        <textarea rows="5" cols="45" name="comments" maxlength="250"></textarea>
                    </div>
    ...
    <script>
        function checkPassword(){
            ...
            if(password.value != check.value){
                check.setCustomValidity("パスワードが一致しません。")
            } else {
